...
import { LobbyController, type MatchStartInfo } from './lobby-controller';
...
export class MultiplayerSession {
  ...
  describe() {
    ...
    return {
      ...
      mapKind: lobby?.roomView?.mapKind ?? null,
  ...
  #openMatch(started: MatchStartInfo): void {
