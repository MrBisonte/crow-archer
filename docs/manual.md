...
| **TALENTS** | Per-character trees bought with feathers and gated by mastery, drafted one-of-three at run start and each boss, with a capstone rite at the top rank. See [Talents](talents.md) |
